    ...
    >
        ...
        <img
          ...
          onError={e => {
            (e.target as HTMLImageElement).src =
              `https://via.placeholder.com/300x200/111118/6B7280?text=${encodeURIComponent(
      ...
      <div className="flex flex-wrap gap-1 mb-4">
        {product.tags.slice(0, 3).map(tag => (
          <span key={tag} className="text-[10px] bg-[#1E1E2E] text-gray-400 px-2 py-0.5 rounded-full">
            #{tag}
          </span>
        ))}
      </div>
